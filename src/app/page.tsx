...
const features = [
  {
    ...
    titleKey: "homeFeatureCvTitle",
    descKey: "homeFeatureCvDesc",
  },
  {
    icon: <Droplets className="w-6 h-6 text-cyan-400" />,
    titleKey: "homeFeatureFeasibilityTitle",
    descKey: "homeFeatureFeasibilityDesc",
  },
  {
    icon: <CloudRain className="w-6 h-6 text-sky-400" />,
    titleKey: "homeFeatureWeatherTitle",
    descKey: "homeFeatureWeatherDesc",
  },
  {
    icon: <Globe className="w-6 h-6 text-purple-400" />,
    titleKey: "homeFeatureGeoTitle",
    descKey: "homeFeatureGeoDesc",
  },
  {
    icon: <Cpu className="w-6 h-6 text-yellow-400" />,
    titleKey: "homeFeatureYardTitle",
    descKey: "homeFeatureYardDesc",
  },
  {
    icon: <Users className="w-6 h-6 text-pink-400" />,
    titleKey: "homeFeatureLeaderboardTitle",
    descKey: "homeFeatureLeaderboardDesc",
  },
  {
    icon: <Shield className="w-6 h-6 text-orange-400" />,
    titleKey: "homeFeatureVendorTitle",
    descKey: "homeFeatureVendorDesc",
  },
  {
    icon: <Download className="w-6 h-6 text-teal-400" />,
    titleKey: "homeFeatureBlueprintTitle",
    descKey: "homeFeatureBlueprintDesc",
  },
  {
    icon: <Zap className="w-6 h-6 text-amber-400" />,
    titleKey: "homeFeatureAiTitle",
    descKey: "homeFeatureAiDesc",
  },
  {
    icon: <BarChart3 className="w-6 h-6 text-emerald-400" />,
    titleKey: "homeFeatureCostTitle",
    descKey: "homeFeatureCostDesc",
  },
  {
    icon: <Leaf className="w-6 h-6 text-green-400" />,
    titleKey: "homeFeatureSubsidyTitle",
    descKey: "homeFeatureSubsidyDesc",
  },
  {
    icon: <TrendingUp className="w-6 h-6 text-rose-400" />,
    titleKey: "homeFeatureImpactTitle",
    descKey: "homeFeatureImpactDesc",
  },
];

const stats = [
  { value: "19", unitKey: "homeStatsStatesUnit", labelKey: "homeStatsCoverageLabel" },
  { value: "61%", unitKey: "", labelKey: "homeStatsExtractedLabel" },
  { value: "₹0", unitKey: "", labelKey: "homeStatsFreeLabel" },
  { value: "10", unitKey: "homeStatsLanguagesUnit", labelKey: "homeStatsLanguageLabel" },
];

const aquiferFacts = [
  { icon: <Building2 className="w-5 h-5 text-blue-400" />, titleKey: "homeFactUrbanTitle", descKey: "homeFactUrbanDesc" },
  { icon: <BookOpen className="w-5 h-5 text-cyan-400" />, titleKey: "homeFactGuideTitle", descKey: "homeFactGuideDesc" },
  { icon: <Waves className="w-5 h-5 text-indigo-400" />, titleKey: "homeFactDepletionTitle", descKey: "homeFactDepletionDesc" },
  { icon: <CloudRain className="w-5 h-5 text-sky-400" />, titleKey: "homeFactMonsoonTitle", descKey: "homeFactMonsoonDesc" },
];
    ...
    <div className="min-h-screen text-white relative overflow-hidden" style={{ background: "linear-gradient(180deg, #020b18 0%, #041426 30%, #061a33 60%, #051220 100%)" }}>
      ...
      <div className="relative z-10">
        ...
        <nav className="sticky top-0 z-40 backdrop-blur-xl border-b border-blue-900/30" style={{ background: "rgba(2,11,24,0.85)" }}>
          <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <span className="font-bold text-white text-lg tracking-tight">{t("brandName")}</span>
                <span className="text-[10px] text-cyan-400 ml-1.5 hidden sm:inline-block bg-cyan-500/10 px-1.5 py-0.5 rounded-full">{t("brandByCgwb")}</span>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-blue-200/80 text-sm leading-relaxed">
                <p>
                  {t("homeWhyPara1Prefix")} <strong className="text-white">{t("homeWhyPara1Strong")}</strong> {t("homeWhyPara1Suffix")}
                </p>
                <p>
                  {t("homeWhyPara2Prefix")} <strong className="text-white">{t("homeWhyPara2Strong")}</strong> {t("homeWhyPara2Suffix")}
                </p>
                <p>
                  {t("homeWhyPara3Prefix")} <strong className="text-yellow-300">{t("homeWhyPara3Strong")}</strong> {t("homeWhyPara3Suffix")}
                </p>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              {[
                { labelKey: "homePanelRunoffLabel", descKey: "homePanelRunoffDesc", icon: "🏠" },
                { labelKey: "homePanelAquiferLabel", descKey: "homePanelAquiferDesc", icon: "🌊" },
                { labelKey: "homePanelStructureLabel", descKey: "homePanelStructureDesc", icon: "🔧" },
                { labelKey: "homePanelCostLabel", descKey: "homePanelCostDesc", icon: "📈" },
              ].map((item, i) => (
        ...
        <section className="border-y border-blue-900/30 py-20" style={{ background: "rgba(0,20,60,0.4)" }}>
          <div className="max-w-5xl mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-white mb-3">{t("homeFeaturesHeading")}</h2>
              <p className="text-blue-300/80">{t("homeFeaturesSub")}</p>
            </div>
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4">
              {features.map((f, i) => (
                <div
        ...
        <section className="max-w-5xl mx-auto px-4 py-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-3">{t("homeHowHeading")}</h2>
            <p className="text-blue-300/80">{t("homeHowSub")}</p>
          </div>
          <div className="grid md:grid-cols-5 gap-4 items-center">
            {[
              { step: 1, titleKey: "homeStep1Title", descKey: "homeStep1Desc", icon: "📍" },
              { step: 2, titleKey: "homeStep2Title", descKey: "homeStep2Desc", icon: "🛰️" },
              { step: 3, titleKey: "homeStep3Title", descKey: "homeStep3Desc", icon: "🗄️" },
              { step: 4, titleKey: "homeStep4Title", descKey: "homeStep4Desc", icon: "📋" },
              { step: 5, titleKey: "homeStep5Title", descKey: "homeStep5Desc", icon: "🏆" },
            ].map((s, i) => (
              <div key={i} className="text-center group">
        ...
        <footer className="border-t border-blue-900/30 py-10">
          <div className="max-w-5xl mx-auto px-4 text-center text-sm text-blue-400/80">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <p className="font-medium">{t("homeFooterTitle")}</p>
            </div>
